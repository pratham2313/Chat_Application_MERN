...
function Person2() {
    ...
    var [receivemess, setreceivemess] = useState({ message: "" });
    useEffect(() => {
        // if (once.current) {
        //     socket.on("getid", (id) => {
        //         setid(id)
        ...
        //     setreceivemess({ message: data.rmess });
        // }
        // )
        // console.log(receivemess.message);
                ...
                <div class="flex flex-row h-full w-full overflow-x-hidden">
                    <div class="flex flex-col py-8 pl-6 pr-2 w-70 bg-white flex-shrink-0">
                        ...
                        <div class="flex flex-col mt-8">
                            ...
                            <div class="border-b-2 py-3 px-2">
                                <input
                                    type="text"
                                    placeholder="search contact"
                                    class="py-0 px-2 border-2 border-gray-200 rounded-2xl w-full"
                                />
                            </div>
